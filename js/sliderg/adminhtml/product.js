Product.Igallery = Class.create();
Product.Igallery.prototype = {
    images : [],
    file2id : {
        'no_selection' :0
    },
    ...
    updateImage : function(file) {
        ...
        this.images[index].urlbanner = this.getFileElement(file,
    ...
    setProductImages : function(file) {
        ...
        this.getElement('save_image').value = Object.toJSON(this.imagesValues);
    },
    updateVisualisation : function(file) {
        var image = this.getImageByFile(file);
        this.getFileElement(file, 'cell-label input').value = image.label;
        this.getFileElement(file, 'cell-urlbanner input').value = image.urlbanner;
        this.getFileElement(file, 'cell-descriptionbanner input').value = image.descriptionbanner;
