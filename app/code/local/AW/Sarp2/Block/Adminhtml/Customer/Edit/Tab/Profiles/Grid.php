...
class AW_Sarp2_Block_Adminhtml_Customer_Edit_Tab_Profiles_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('awsarp2_customer_profiles_grid');
    ...
    {
        $profileCollection = Mage::getResourceModel('aw_sarp2/profile_collection')->addCustomerFilter(
    ...
    {
        return $this->getUrl('aw_recurring_admin/adminhtml_customer/grid', array('_current' => true));
    }
}