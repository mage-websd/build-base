...
class AW_Sarp2_CustomerController extends Mage_Core_Controller_Front_Action
{
    ...
    public function cancelAction()
    {
        ...
        Mage::getSingleton('core/session')->addSuccess($this->__('Subscription successfully cancelled'));
        return $this->_redirect('*/*/view', array('_current' => true));
    }
    ...
    public function suspendAction()
    {
        ...
        Mage::getSingleton('core/session')->addSuccess($this->__('Subscription successfully suspended'));
        return $this->_redirect('*/*/view', array('_current' => true));
    }
    ...
    public function activateAction()
    {
        ...
        Mage::getSingleton('core/session')->addSuccess($this->__('Subscription successfully activated'));
        return $this->_redirect('*/*/view', array('_current' => true));
    }
    ...
    public function updateAction()
    {
        ...
        try {
            ...
            Mage::getSingleton('core/session')->addSuccess($this->__('Subscription successfully updated'));
        } catch (Exception $e) {
            Mage::getSingleton('core/session')->addError($this->__('Unable update subscription'));
        }
        return $this->_redirect('*/*/view', array('_current' => true));
    }
}