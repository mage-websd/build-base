...
class AW_Sarp2_Model_Engine_Authorizenet_Engine implements AW_Sarp2_Model_Engine_EngineInterface
{
    ...
    protected $_mapRestrictionsToProfile = array(
        ...
        'status'                        => 'status',
        'subscription_name'             => 'details/order_item_info/name',
        ...
        'trial_amount'                  => 'details/order_item_info/subscription_trial_payment',
    ...
    protected function _importDataForService(AW_Sarp2_Model_Profile $p)
    {
        ...
        if (isset($data['subscription']['trialAmount'])) {
            $data['subscription']['trialAmount'] += $p->getData('details/shipping_amount') + $p->getData('details/order_item_info/base_subscription_trial_tax');
        }
