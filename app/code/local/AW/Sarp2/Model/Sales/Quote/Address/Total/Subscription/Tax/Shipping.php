...
/**
 * Subscription shipping tax total
 */
class AW_Sarp2_Model_Sales_Quote_Address_Total_Subscription_Tax_Shipping
    extends Mage_Tax_Model_Sales_Total_Quote_Shipping
{
    /**
