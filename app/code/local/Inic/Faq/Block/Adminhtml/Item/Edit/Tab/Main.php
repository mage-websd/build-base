...
class Inic_Faq_Block_Adminhtml_Item_Edit_Tab_Main extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $approveInfo = $fieldset->addField('question', 'text', array(
            'name' => 'question',
        ...
        if (!Mage::app()->isSingleStoreMode()) {
            ...
            $store_id = $fieldset->addField('store_id', 'hidden', array(
                'name' => 'store_id[]',
        ...
        $status = $fieldset->addField('is_active', 'select', array(
        ...
        $fieldset->addField('is_most_frequent', 'select', array(
        ...
        $category_id = $fieldset->addField('category_id', 'multiselect', array(
