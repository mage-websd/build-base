...
?>
<?php
class MagenThemes_Megamenu_Block_Adminhtml_Megamenu_Edit_Tab_Category extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('megamenu/edit/tabs/category.phtml');
    }
    ...
    {
        return Mage::registry('megamenu_data');
    }
    ...
    {
        return $this->getMegamenu()->getCategoriesReadonly();
    }

    protected function getCategoryIds()
    {
        $_categoryList = $this->getMegamenu()->getCategories();
    ...
    public function getCategoryChildrenJson($categoryId)
    {
        ...
        return Mage::helper('megamenu')->jsonEncode($children);
    }
