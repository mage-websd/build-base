...
?>
<?php
class MagenThemes_Megamenu_Block_Adminhtml_Megacategory_Edit_Form extends MagenThemes_Megamenu_Block_Adminhtml_Megacategory_Tree
{
  protected $_additionalButtons = array();
    ...
    public function getHeader()
    {
      	if ($this->getMegamenu()->getId()) {
	  		...
	  		if ($parentId) {
	      		return Mage::helper('catalog')->__('New Sub megaCategory');
	  		} else {
	      		return Mage::helper('catalog')->__('New Root Megacategory');
	  		}
      	}
    }
