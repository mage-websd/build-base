...
class Gsd_GroupedConfigrableg_Block_Catalog_Product_View_Type_Configurable extends Mage_Catalog_Block_Product_View_Type_Configurable {
     ...
     * @return string
     */
    public function getJsonConfigParent() {
        $attributes = array();
        $options = array();
        ...
        foreach ($this->getAllowProducts() as $product) {
            ...
            foreach ($this->getAllowAttributes() as $attribute) {
                ...
                /* more core */
                $this->_jsonOptionProduct[$attributeValue]['product'][] = $productId;
                $this->_jsonOptionProduct[$attributeValue]['attribute'] = $productAttributeId;
