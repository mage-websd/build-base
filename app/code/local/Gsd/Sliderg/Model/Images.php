<?php
class Gsd_Sliderg_Model_Images extends Mage_Core_Model_Abstract
{
    protected $_width;
    protected $_height;
    ...
    protected $_defaultImage='default.png';
    ...
    /**
     * @param $image
     * set default image if not exists image, basedirmedia/$image
     */
...
//        print '$this->_getNeedMemoryForBaseFile() = '.$this->_getNeedMemoryForBaseFile();
        ...
        return (
                    ...
                    ($this->_getMemoryUsage() + $this->_getNeedMemoryForFile($file))
                )
            ||
                (
...
//            }
    ...
    {
        $directory = Mage::helper('sliderg')->getBaseMediaPath() .'cache'.DS;
