<?php
class Gsd_Sliderg_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('sliderg/images'));
        ...
        if ($imageFile) {
            ...
            //$this->_getModel()->setBaseFile( $this->getSlider()->getData($this->_getModel()->getDestinationSubdir()) );
        }
        return $this;
    }
     ...
     *
     * @see My_Igallery_Model_Banner_Image
     * @param int $width
     * @param int $height
     * @return My_Igallery_Helper_Image
     */
    ...
    protected function setSlider($slider)
    {
        $this->_slider = $slider;
        return $this;
    }
