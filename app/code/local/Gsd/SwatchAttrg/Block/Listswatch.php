...
class Gsd_SwatchAttrg_Block_Listswatch extends Mage_Core_Block_Template {

    protected function _construct() {
        parent::_construct();
        $this->setTemplate('swatchattrg/listswatches.phtml');
    ...
    public function getListSwatchAttributes() {
        ...
        $swatchattributes = Mage::getStoreConfig('swatchattrg/general/toshow', Mage::app()->getStore());
    ...
    public function getListSwatchHtml($_attributes, $productId) {
        ...
        foreach ($_attributes as $_attribute):
            ...
            if (in_array($_attribute['attribute_code'], $swatch_attributes)):
                ...
                $swatchsize = Mage::helper('swatchattrg/data')->getSwatchSize('list');
