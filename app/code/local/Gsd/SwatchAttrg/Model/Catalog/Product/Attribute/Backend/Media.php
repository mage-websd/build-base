 ...
 */
class Gsd_SwatchAttrg_Model_Catalog_Product_Attribute_Backend_Media extends Mage_Catalog_Model_Product_Attribute_Backend_Media {
    ...
    public function afterLoad($object) {
        ...
        $value['images'] = array();
        $value['values'] = array();
        $localAttributes = array('label', 'position', 'disabled', 'defaultimg', 'selectorbase', 'selectormore');
    ...
    public function afterSave($object) {
        ...
        foreach ($value['images'] as &$image) {
            ...
            $data['selectorbase'] = (int) $image['selectorbase'];
            $data['selectormore'] = (int) $image['selectormore'];
    ...
    public function addImage(Mage_Catalog_Model_Product $product, $file, $mediaAttribute = null, $move = false, $exclude = true) {
        ...
        foreach ($mediaGalleryData['images'] as &$image) {
            if (isset($image['selectorbase']) && $image['selectorbase'] > 0) {
                $selectorbase = $image['selectorbase'];
            }
        }

        foreach ($mediaGalleryData['images'] as &$image) {
            if (isset($image['selectormore']) && $image['selectormore'] > 0) {
                $selectormore = $image['selectormore'];
            }
        }
        ...
        $mediaGalleryData['images'][] = array(
            ...
            'selectorbase' => (int) $selectorbase,
            'selectormore' => (int) $selectormore,
        );
