...
class Gsd_SwatchAttrg_Model_Source_Config_Toshow {
    ...
    public static function getTheSwatchAttributes() {
        ...
        $swatchattributes = Mage::helper('swatchattrg/config')->getConfig('general','colorattributes');
    ...
    public static function toOptionArray() {
        if (is_array(self::$_productAttributeOptions))
