<?php
class Gsd_Catalogg_Model_Product extends Mage_Catalog_Model_Layer
{
    ...
    public function getProductCollection($productIdFilter=null) {
        if (is_null($this->_productCollection)) {
            ...
            $rulePriceWhere = "({{table}}.rule_date is null) or ".
            	"({{table}}.rule_date='$todayDate' and ".
        		"{{table}}.website_id='$websiteId' and ".
        		"{{table}}.customer_group_id='$custGroup')";
            ...
            if (!empty($productIds)) {
                $specials->setPageSize(1)->setCurPage(1);
            }
