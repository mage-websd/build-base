<?php
class Emosys_ReviewCustomerg_Adminhtml_Reviewg_CustomerController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->_initLayout();
        $this->_addContent($this->getLayout()->createBlock('review_customerg/adminhtml_review'));
        $this->renderLayout();
    }
    ...
    public function editAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('review_customerg/adminhtml_review_edit'))
            ->_addLeft($this->getLayout()->createBlock('review_customerg/adminhtml_review_edit_tabs'));
        $this->renderLayout();
    }
    ...
    public function gridAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('review_customerg/adminhtml_review_grid')->toHtml()
        );
    }
