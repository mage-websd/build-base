...
$tableRating = $installer->getTable('review_customerg/rating');
$tableRatingEntity = $installer->getTable('review_customerg/ratingentity');
$tableReview = $installer->getTable('review_customerg/review');
