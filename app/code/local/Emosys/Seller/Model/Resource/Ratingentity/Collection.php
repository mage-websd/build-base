<?php
class Emosys_Seller_Model_Resource_Ratingentity_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    ...
    {
        $reviewTable = $this->getTable('seller/review');
        $this->getSelect()
    ...
    {
        $reviewTable = $this->getTable('seller/review');
        $ratingTable = $this->getTable('seller/rating');
        $this->getSelect()
            ->reset(Zend_Db_Select::COLUMNS)
