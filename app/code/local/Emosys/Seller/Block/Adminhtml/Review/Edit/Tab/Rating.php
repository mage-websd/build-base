<?php
class Emosys_Seller_Block_Adminhtml_Review_Edit_Tab_Rating extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $ratings = Mage::getModel('seller/rating')->getCollection()->setOrder('position','asc');
        $optionRating = array();
        for($i = 1 ; $i <= Mage::helper('seller/review')->getMaxRating() ; $i++) {
