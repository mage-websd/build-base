 ...
 */
class Emosys_Seller_Block_Adminhtml_Customer_Edit_Tab_Account extends Mage_Adminhtml_Block_Customer_Edit_Tab_Account
{
    /**
     * Initialize form
     *
...
//        }
        ...
        if ($customer->getId()) {
            if (!$customer->isReadonly()) {
                ...
                if ($confirmationKey || $customer->isConfirmationRequired() || ($customer->getIsVendor() == '1') ) {
