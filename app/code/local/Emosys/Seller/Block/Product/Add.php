...
class Emosys_Seller_Block_Product_Add extends Mage_Core_Block_Template
{
    protected $_categoiesProduct = array();
    ...
    {
        if($this->getProduct()) {
            $this->_categoiesProduct = $this->getProduct()->getCategoryIds();
        }
